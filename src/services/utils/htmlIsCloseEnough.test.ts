...
describe("html can be close enough", () => {
  ...
  it("scenario 2", () => {
    ...
    expect(removeHtmlDetails(localHTML)).not.toBe(
      removeHtmlDetails(canvasHTML)
    );
  });
  it("scenario 3", () => {
  ...
  it("image upload scenario", () => {
    const localHTML = `<p><a href="https://classroom.github.com/a/dtwXbB3a">Github Classroom</a> (same repo as part 1)</p>
<p>This assignment is similar to the format that our exam will be in class. The exam will be open 1 page of handwritten notes, open VSCode (no AI extensions), and closed everything else (neighbor, internet, etc.). Attempt to complete this assignment with only your handwritten notes and VSCode.</p>
<p>Recreate this page:</p>
<p><img src="https://snow.instructure.com/files/183104073/download?download_frd=1&verifier=oRDn7qVDzFZKOEzUlfLIBe6H5an0F96FfaYbbJlg" alt="website to recreate"></p>
<ul>
<li>The github classroom repository has an images folder with the images used on the page.</li>
<li>The "Apply Now" and "Request Info" buttons are links to another page (send the links to wherever you want)</li>
<li>Add a shadow around the "Apply Now" "Request Information" and "Visit Campus / SNOWBLAST" cards on hover.<ul>
<li>Make the cards larger on hover</li>
<li>Have the hover effects have a 1 second transition</li>
</ul>
</li>
</ul>
<p>Submit a screenshot of your copy of the website.</p>`;

    const canvasHTML = `<link rel="stylesheet" href="https://instructure-uploads-2.s3.amazonaws.com/account_20000000000010/attachments/162497727/DesignPlus%20Mobile%20%25282024%20May%2013%2529.css"><p><a href="https://classroom.github.com/a/dtwXbB3a">Github Classroom</a> (same repo as part 1)</p>
<p>This assignment is similar to the format that our exam will be in class. The exam will be open 1 page of handwritten notes, open VSCode (no AI extensions), and closed everything else (neighbor, internet, etc.). Attempt to complete this assignment with only your handwritten notes and VSCode.</p>
<p>Recreate this page:</p>
<p><img src="https://snow.instructure.com/courses/1154759/files/183104073/download?verifier=oRDn7qVDzFZKOEzUlfLIBe6H5an0F96FfaYbbJlg" alt="website to recreate" loading="lazy" data-api-endpoint="https://snow.instructure.com/api/v1/courses/1154759/files/183104073" data-api-returntype="File"></p>
<ul>
<li>The github classroom repository has an images folder with the images used on the page.</li>
<li>The "Apply Now" and "Request Info" buttons are links to another page (send the links to wherever you want)</li>
<li>Add a shadow around the "Apply Now" "Request Information" and "Visit Campus / SNOWBLAST" cards on hover.<ul>
...
<p>Submit a screenshot of your copy of the website.</p>
<script src="https://instructure-uploads-2.s3.amazonaws.com/account_20000000000010/attachments/182339931/Canvas%20Mobile%20Theme%20%2528August%2025%2529%20Verity.js"></script>`;
